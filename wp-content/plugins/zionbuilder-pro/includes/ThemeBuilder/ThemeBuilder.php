...
class ThemeBuilder {
	...
	public function __construct() {
		...
		add_filter( 'zionbuilder/rest/templates/attach_data', [ $this, 'attach_template_area' ] );
	 ...
	 * @return void
	 */
	public function on_added_template( $template, $request ) {
	...
	public function attach_template_area( $template ) {
		if ( $template['template_type'] === 'theme_builder' ) {
