...
class PostTerms extends BaseField {
	...
	/**
	 * Retrieve the formatted post custom taxonomies to be used in the options
	 *
	 * @return array
	 */
	private function __getFormattedTaxonomies() {
		$post       = $GLOBALS['post'];
		$options    = [];
