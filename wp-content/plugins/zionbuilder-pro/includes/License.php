...
class License {
	...
	public function __construct() {
		...
		add_filter( 'zionbuilder/pro/is_conected', [ $this, 'has_valid_license' ] );
		add_filter( 'zionbuilder/utils/pro_active', [ $this, 'has_valid_license' ] );
		add_filter( 'zionbuilder/template/insert/template_file', [ $this, 'get_pro_template_download_url' ], 10, 2 );
	}
	...
	public function get_pro_template_download_url( $template_file, $request ) {
		$is_pro = $request->get_param( 'pro' );
		...
		if ( $is_pro ) {
			...
			$response = wp_remote_post(
				self::LIBRARY_URL . 'get_download_url',
				[
					'timeout'   => 15,
					'body'      => $api_params,
				]
