...
class DeterminaCostituzioneDocument
{
    ...
    public function __construct()
    {
        ...
        foreach ($this->infos as $value) {
            $value["valore"] =  preg_replace('/"/', '\"', $value["valore"]);
            $value["valore"] =  preg_replace("/'/", '\"', $value["valore"]);
    ...
    public function render()
    {
            ...
            <script>
                ...
                $(document).ready(function () {
                    ...
                    $('.btn-save-edit').click(function () {
                        ...
                        console.log(payload)
                        $.ajax({
                            url: '<?= DateXFondoCommon::get_website_url() ?>/wp-json/datexfondoplugin/v1/determinadocument',
                            data: payload,
                            type: "POST",
        ...
        <div id="cont_determinaCostituzioneContent">

            <style type="text/css">

                #determinaCostituzioneContent
                {
                    position:relative;
                    z-index: 10;
                    top: 0px;
                ...
                #determinaCostituzioneContent h2 {
                    font-size: 18pt;
                ...
                #determinaCostituzioneContent h3 {
                    font-size: 16pt;
                    margin: 30px 0px 20px;
                    font-weight: 500;
                }

                #determinaCostituzioneContent h4 {
                    font-size: 15pt;
                    margin: 30px 0px 20px;
                    font-weight: 700;
                    letter-spacing: 2px;
                ...
                #determinaCostituzioneContent h6 {
                    font-size: 15pt;
                    margin: 30px 0px 20px;
                    font-weight: 700;
                    letter-spacing: 2px;
                ...
                #determinaCostituzioneContent ul.d
                {
                    position:relative;
                    z-index: 10;
                    top: 0px;
                ...
                #determinaCostituzioneContent ul.d li
                {
                    position:relative;
                    z-index: 10;
                    top: 0px;
                ...
                #determinaCostituzioneContent ul.a
                {
                    position:relative;
                    z-index: 10;
                    top: 0px;
                ...
                #determinaCostituzioneContent ul.a li
                {
                    position:relative;
                    z-index: 10;
                    top: 0px;
                ...
                #determinaCostituzioneContent ul.a li ul.c
                {
                    position:relative;
                    z-index: 10;
                    top: 0px;
                ...
                #determinaCostituzioneContent ul.a li ul.c li
                {
                    position:relative;
                    z-index: 10;
                    top: 0px;
                ...
                #determinaCostituzioneContent ul.n
                {
                    position:relative;
                    z-index: 10;
                    top: 0px;
                ...
                #determinaCostituzioneContent ul.n li
                {
                    position:relative;
                    z-index: 10;
                    top: 0px;
                ...
                #determinaCostituzioneContent table
                {
                    position:relative;
                    z-index: 10;
                    top: 0px;
                ...
                #determinaCostituzioneContent table thead tr
                {
                    border: 1px solid black;
                    font-weight: 700;
                }
                #determinaCostituzioneContent table thead tr th
                {
                    border: 1px solid black;
                    font-weight: 700;
                }

                #determinaCostituzioneContent table tbody tr
                {
                    border: 1px solid black;
                }
                #determinaCostituzioneContent table tbody tr td
                {
                    border: 1px solid black;
                }
            ...
            <div id="determinaCostituzioneContent">
                <h3>Determinazione del <?php self::getInput('var0', 'nome_soggetto_deliberante', 'orange'); ?></h3>
                <br>
                <br>
                <h6>OGGETTO: COSTITUZIONE FONDO DELLE RISORSE DECENTRATE PER
                ...
                <ul class="d">
                    ...
                    <li>i successivi atti di variazione del bilancio e del P.E.G.;</li>
                    <li>il vigente Regolamento di Organizzazione degli Uffici e dei Servizi;</li>
                    <li>il vigente regolamento di contabilità;</li>
                    <li>il T.U. sull’ordinamento degli Enti locali, approvato con D.Lgs... n. 267/2000;</li>
                    <li>il C.C.D.I. per la distribuzione del fondo delle risorse
                        decentrate <?php self::getInput('var12', 'F13', 'orange'); ?>;</li>
                    <li>il nuovo CCNL siglato in data 21.5.2018;</li>
                    <li>il CCNL siglato in data 16.11.2022</li>
                    <li>la
                ...
                <ul class="d">
                        ...
                        <li><?php self::getInput('var18', 'il/la', 'orange'); ?><?php self::getInput('var19', 'nome_soggetto_deliberante', 'orange'); ?>
                ...
                <b> Considerato che:</b>
                <ul class="d">
                    <li>ai sensi dell’art. 67 del CCNL 21.5.2018, devono essere annualmente destinate risorse per le politiche
                        di sviluppo delle risorse umane e per la produttività collettiva e individuale;</li>
                    <li>la costituzione di tale fondo risulta di competenza
                        del <?php self::getInput('var21', 'nome_soggetto_deliberante', 'orange'); ?> ;</li>
                </ul>
                ...
                <b>Considerato che:</b>
                <ul class="d">
                    <li>l’art. 67 comma 1 del CCNL 21.5.2018 ha definito che le risorse aventi carattere di certezza, stabilità
                        ...
                        <li>ai sensi dell’art. 67 comma 2 lett. c) CCNL 22.5.2018 che prevede che “le risorse di cui al comma 1, sono
                        ...
                        <li>ai sensi dell’art. 67 comma 5 lett. a) CCNL 22.5.2018 che prevede “in caso di incremento delle dotazioni
                        ...
                        <li>ai sensi dell’art. 67 comma 2 lett. g) del CCNL 22.5.2018 si inseriscono le somme per la riduzione stabile
                            del fondo dello straordinario, ad invarianza complessiva di risorse stanziate, per
                            € <?php self::getInput('var29', 'R127', 'orange'); ?>;
                        </li>

                        <li>ai sensi dell’art. 67 comma 2 lettera e) del CCNL 22.5.2018 si inseriscono gli importi necessari a
                            sostenere
                        ...
                        <li>ai sensi dell’art. 67 comma 2 lettera d) del CCNL 22.5.2018 si inseriscono risorse riassorbite ai sensi
                            dell’art. 2, comma 3, del D.Lgs. 30 marzo 2001, n. 165, per un importo di
                            € <?php self::getInput('var31', 'R125', 'orange'); ?>;
                        </li>

                        <li>ai sensi dell’art.<?php self::getInput('var32', 'xx comma x del CCNL xx.xx.xxxx', 'orange'); ?> si
            ...
            LIBERO SE SONO STATE AGGIUNTE ALTRE RISORSE NELLA PARTE STABILE)', 'orange'); ?> ;
                        ...
                        <li>ai sensi dell’art. 67 comma 2 lettera b) del CCNL 22.5.2018 si inseriscono le somme di un importo pari
                            alle
                        ...
                        <li>ai sensi dell’art. 67 comma 2 lettera a) del CCNL 22.5.2018 si inseriscono le somme di un importo su base
                        ...
                        <li>ai sensi dell’art. 67 comma 2 lettera e) del CCNL 22.5.2018 e art 1 c 800 L. 205/2017 relativo
                        ...
                        <li>ai sensi dell'art 11 D.L. 135/2018 c. 1 lett. b) si inseriscono le somme per un importo di
                        ...
                        <li>per effetto del trasferimento dell’ex personale ATA da questo Ente presso il Comparto Scuola, già a far
                            data
                            dall’anno 2000, sono state decurtate dal fondo risorse pari ad
                            € <?php self::getInput('var37', 'R25', 'orange'); ?>;
                        </li>

                        <li>già a partire dall’anno xxxx, a seguito dell'affidamento delle posizioni organizzative e della relativa
            ...
            Posizione organizzativa)', 'orange'); ?>, per un valore pari ad
                        ...
                        <li>già a partire dall’anno 1999, a seguito del primo inquadramento di alcune categorie di lavoratori in
                        ...
                        <li>il fondo viene decurtato per
                            € <?php self::getInput('var41', '(INSERIRE IL TITOLO TESTO LIBERO SE SONO STATE DECURTATE ALTRE RISORSE NELLA PARTE STABILE)', 'orange'); ?>
                            ;
                        </li>

                    <li>il fondo viene decurtato per</li>
                    <li>ai sensi dell’art. 67 comma 2 lettera e) del CCNL 22.5.2018 si procede alla decurtazione degli importi
                ...
                <ul class="d">
                        ...
                        <li>il numero di dipendenti in servizio nell’anno, calcolato in base alle modalità fornite dalla Ragioneria
                        ...
                        <li>Si precisa che, in base agli indirizzi
                    ...
                    <li><?php self::getTextArea('area3', 'l’Ente si impegna a modificare la presente costituzione del fondo nel caso di incremento o diminuzione del
            ...
            integrazione', 'red'); ?>;
                    ...
                    <ul class="d">
                            ...
                            <li>ai sensi dell’art. 67 comma 4 CCNL 21.5.2018, le risorse economiche derivanti dal calcolo fino ad un
                            massimo
                            ...
                            <li>ai sensi dell’art. 67 comma 3 lett. a) CCNL 21.5.2018 le somme derivanti da contratti di sponsorizzazione,
                            ...
                            <li>ai sensi dell’art. 67 comma 3 lett. c) CCNL 21.5.2018, le somme destinate alle attività di recupero ICI
                                per
                                € <?php self::getInput('var52', 'R30', 'orange'); ?>;
                            </li>

                            <li>ai sensi dell’art. 67 comma 3 lett. c) CCNL 21.5.2018, le somme destinate al finanziamento delle attività
                            ...
                            <li>ai sensi dell’art. 67 comma 3 lett. f) CCNL 21.5.2018 una quota parte del rimborso spese per ogni
                                notificazione di atti per €<?php self::getInput('var54', 'R32', 'orange'); ?> ;
                            </li>

                            <li>ai sensi dell’art. 67 comma 5 lett. b) CCNL 21.5.2018, le somme per il conseguimento di obiettivi
                                dell’ente,
                                ...
                                <br>
                                    ...
                                    <ul class="c">
                                        ...
                                        <li><?php self::getInput('var56', '  xxxxx, (specificare almeno gli importi previsti per ogni obiettivo)', 'orange'); ?>
                                            ;
                                        </li>
                                        <li><?php self::getInput('var57', '  xxxxx', 'orange'); ?>
                                            <br>
                            ...
                            <li>ai sensi dell’art. xx comma x del CCNL <?php self::getInput('var58', 'xx.xx.xxxx', 'orange'); ?>, le somme
            ...
            STATE AGGIUNTE ALTRE RISORSE NELLA PARTE VARIABILE)', 'red'); ?>;
                            ...
                            <li>ai sensi dell’art. 67 comma 3 lett. d) CCNL 21.5.2018, le somme una tantum corrispondenti alla frazione di
                            ...
                            <li>ai sensi dell’art. 67 comma 3 lett. g CCNL 21.5.2018, le somme per gli importi delle risorse destinate ai
                            ...
                            <li>ai sensi dell’art. 67 comma 3 lett. k CCNL 21.5.2018, le somme per gli importi a seguito dei trasferimenti
                            ...
                            <li>ai sensi dell’art. 67 c. 7 e Art.15 c. 7 CCNL 2018 le somme pari alla quota di incremento del Fondo
                    ...
                    vigente, degli importi NON soggetti al limite del 2016, di cui all’art. 23 del D.Lgs. 75/2017 mediante:
                        ...
                        <ul class="d">
                        <li>iscrizione, ai sensi dell’art. 67 comma 3 lett. c) CCNL 21.5.2018, delle somme destinate alle attività
                            svolte per conto dell’ISTAT per €<?php self::getInput('var60', 'R39', 'orange'); ?>;
                        </li>

                        <li>iscrizione, ai sensi dell’art. 67 comma 3 lett. c) CCNL 21.5.2018, delle somme destinate alla “avvocatura”
                            per € <?php self::getInput('var61', 'R40', 'orange'); ?>;
                        </li>

                        <li>iscrizione, ai sensi dell’art. 67 comma 3 lett. c) CCNL 21.5.2018 delle somme finanziate da fondi di
                            derivazione dell'Unione Europea per € <?php self::getInput('var62', 'R41', 'orange'); ?>;
                        </li>

                        <li>iscrizione, ai sensi dell’art. 67 comma 3 lett. c) del CCNL 21.5.2018 delle somme destinate alle attività
                        ...
                        <li>iscrizione, ai sensi dell’art. 67 comma 3 lett. c) CCNL 21.5.2018 e dell’art. 16 comma 5 della Legge
                        ...
                        <li>iscrizione, ai sensi dell’art. 67 comma 3 lett. e) CCNL 21.5.2018, delle somme derivanti dai risparmi del
                            Fondo lavoro straordinario anno precedente, pari ad €<?php self::getInput('var66', 'R45', 'orange'); ?> ;
                        </li>

                        <li>iscrizione, ai sensi dell’art. 68 comma 1 CCNL 21.5.2018, delle risorse derivanti dai risparmi di parte
                            stabile del Fondo risorse decentrate degli anni precedenti, pari ad
                            € <?php self::getInput('var67', 'R44', 'orange'); ?>;
                        </li>

                        <li>iscrizione, ai sensi dell’art. 67 comma 3 lett. a) CCNL 21.5.2018, delle somme derivanti da contratti di
                        ...
                        <li>iscrizione, ai sensi 67 comma 3 lett. c) CCNL 21.5.2018, delle somme destinate ai cosiddetti incentivi per
                            funzioni tecniche D.Lgs... 50/2016 e ss.mm.ii. per €<?php self::getInput('var69', 'R122', 'orange'); ?> ;
                        </li>

                        <li>iscrizione ai sensi dell’art. 67, comma 5 lett. b) del CCNL 21.5.2018, della sola quota di maggior incasso
            ...
            LIBERO SE SONO STATE AGGIUNTE ALTRE RISORSE NELLA PARTE VARIABILE NON SOTTOPOSTA A BLOCCO)', 'red'); ?>
                ...
                <br>
                <ul class="d">
                    <li>che l'ammontare complessivo delle risorse destinate annualmente al trattamento accessorio del personale,
                ...
                <ul class="d">
                    <li>non poteva superare il corrispondente importo dell’anno 2015;
                    </li>
                    <li>doveva essere automaticamente ridotto in misura proporzionale alla riduzione del personale in servizio,
                ...
                <br>
                    ...
                    <ul class="d">
                        ...
                        <li>Fondo risorse decentrate, come indicato nei paragrafi precedenti per
                ...
                <b> Considerato che</b>
                <ul class="d">
                    <li>il limite di cui all’art. 23 c. 2 del D.Lgs... 75/2017 deve essere rispettato per l’amministrazione nel
                        suo
                        ...
                        <li>l'Ente si è avvalso della facoltà prevista dall'art. 11-bis comma 2 D.L. 135/2018, che prevede di
                            utilizzare
                ...
                <ul class="d">
                    ...
                    <li>Il totale del fondo complessivo (incluse le voci non soggette al blocco dell’art. 23 del D.Lgs... 75/2017)
                        ...
                        <li>il tetto del salario accessorio di cui all’art. 23 c. 2 del D.Lgs... 75/2017 nel suo complesso (indennità
                            ...
                            <br>
                        <li><p style="color: red">ATTENZIONE: In caso di superamento del limite si consiglia di intervenire su
...
', 'orange'); ?>  </td>
                ...
                <br>
                <ol>
                    <li>di costituire il fondo risorse decentrate anno <?php self::getInput('var153', 'anno', 'orange'); ?>,
                        approvando l’allegato schema di costituzione;
                    </li>
                    <li>di applicare l'art. 23 del D.Lgs. 75/2017 che prevede il “blocco” rispetto al fondo dell'anno 2016 del
                        trattamento accessorio, con l’automatica riduzione delle risorse in caso di superamento rispetto all’anno
                        2016;
                    </li>
                    <li>di applicare l’art. 33 comma 2, del D.L.34/2019, convertito in Legge 58/2019 (c.d. Decreto “Crescita”)
            ...
            etc….', 'orange'); ?>
                    ...
                    <li>che il grado di raggiungimento del Piano delle Performance assegnato nell’anno al Dirigente/Posizioni
                    ...
                    <li>che il presente provvedimento diventerà esecutivo solo a seguito dell’apposizione del visto di regolarità
                    ...
                    <li><p style="color: red">di trasmettere la presente al Revisore dei Conti per la certificazione di
                            competenza.</p>
                    </li>
                    <li>di trasmettere la presente alle Organizzazioni Sindacali Territoriali e alle RSU per opportuna
                        conoscenza e informazione.
                    </li>
                </ol>


                <center><b>Il responsabile</b></center>
                <br>
                ...
                <center><b>VISTO DI REGOLARITA’ CONTABILE</b></center>
                <br>
