...
class DeliberaIndirizziDocument
{
    ...
    public function render()
    {
        ...
        <head>
            ...
            <script>
                ...
                function exportHTML() {
                    ...
                    const bodyHTML = $("#cont_DeliberaIndirizziDocument").clone(true);
        ...
        <div id="cont_DeliberaIndirizziDocument" class="div_Delibera">
            <style id="styleDoc">

                #DeliberaIndirizziDocument {
                    position: relative;
                    z-index: 10;
                    top: 0;
                    left: 0;
                ...
                #DeliberaIndirizziDocument b {
                    font-weight: 700;
                }


                #DeliberaIndirizziDocument h2 {
                    font-size: 15pt;
                    margin: 30px 0 10px;
                    font-weight: 700;
                    letter-spacing: 3px;
                ...
                #DeliberaIndirizziDocument h3 {
                    font-size: 13pt;
                    margin: 30px 0 20px;
                    font-weight: 500;
                }

                #DeliberaIndirizziDocument h4 {
                    font-size: 15pt;
                    margin: 30px 0 20px;
                    font-weight: 700;
                    letter-spacing: 2px;
                ...
                #DeliberaIndirizziDocument ul.d {
                    position: relative;
                    z-index: 10;
                    top: 0;
                    left: 0;
                ...
                #DeliberaIndirizziDocument ul.d li {
                    position: relative;
                    z-index: 10;
                    top: 0;
                    left: 0;
                ...
                #DeliberaIndirizziDocument ul.a {
                    position: relative;
                    z-index: 10;
                    top: 0;
                    left: 0;
                ...
                #DeliberaIndirizziDocument ul.a li {
                    position: relative;
                    z-index: 10;
                    top: 0;
                    left: 0;
                ...
                #DeliberaIndirizziDocument ul.a li ul.c {
                    position: relative;
                    z-index: 10;
                    top: 0;
                    left: 0;
                ...
                #DeliberaIndirizziDocument ul.a li ul.c li {
                    position: relative;
                    z-index: 10;
                    top: 0;
                    left: 0;
                ...
                #DeliberaIndirizziDocument ul.n {
                    position: relative;
                    z-index: 10;
                    top: 0;
                    left: 0;
                ...
                #DeliberaIndirizziDocument ul.n li {
                    position: relative;
                    z-index: 10;
                    top: 0;
                    left: 0;
