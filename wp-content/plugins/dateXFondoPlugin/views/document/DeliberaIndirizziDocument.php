...
class DeliberaIndirizziDocument
{
    ...
    public function render()
    {
        ...
        <div id="DeliberaIndirizziDocument">
            <h2><?php self::getInput('var1', 'Il/La', 'orange'); ?><?php self::getInput('var2', 'Il/La nome_soggetto_deliberante', 'orange'); ?> </h2>
            ...
            <b>Premesso</b> che in data 21.5.2018 è stato sottoscritto il Contratto Collettivo Nazionale di Lavoro del
            ...
            <br>
            <br>
            <b>Visto</b> l'art. 1 c. 236 della L. 208/2015 (Legge di stabilità 2016) che stabiliva “Nelle more
            dell’adozione
            ...
            <br>
            <br>
            <b>Richiamato</b> l'art. 33 comma 2, del D.L. n. 34/2019, convertito in Legge 58/2019 (c.d. Decreto
            “Crescita”) e
            ...
            <br>
            <?php self::getTextArea('areai', 'SCRIVERE QUALCOSA SE PER CASO È STATA ADOTTATA PRECEDENTEMENTE LA DETERMINA DI PARTE STABILE', 'red'); ?>
            <br>
            <br>
            <b>Tenuto conto</b> che nel periodo 2011-2014<?php self::getSelect('formula1', 'formula1'); ?> risultano
            decurtazioni
            ...
            a
            <b>€</b><?php self::getSelect('formula3', 'formula3'); ?>;
            <br>
            <br>
            ...
            <b>€</b> <?php self::getSelect('formula4', 'formula4'); ?>.
            <br>
            <br>
            ...
            <br>
            <br>
            <?php self::getInput('var22', ' il/la', 'orange'); ?> <?php self::getInput('var23', 'titolo_ente', 'orange'); ?>
            ...
            <br>
            il/la <?php self::getInput('var24', 'var23', 'orange'); ?> ha rispettato i vincoli previsti
            dalle
            regole del cosiddetto “Equilibrio di Bilancio” e il
            ...
            all’iscrizione tra le risorse variabili di €<?php self::getSelect('formula24', 'formula24'); ?>, che
            dovranno
            essere
            ...
            data <?php self::getInput('var36', 'xxxx/xxxx', 'orange'); ?> per la ripartizione economica dell’anno
            e
            ...
            <br>
            <br>
            3. di inviare il presente provvedimento al responsabile
            per
