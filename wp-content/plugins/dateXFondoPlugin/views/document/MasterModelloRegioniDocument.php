...
public static function render()
{
    ...
    if(isset($_GET['version']) && isset($_GET['anno'])){
       $results_articoli_costituzione = $data->getHistoryCostituzioneArticoli($_GET['editor_name'],$_GET['version'],$_GET['anno']);
       $results_articoli_destinazione = $data->getHistoryDestinazioneArticoli($_GET['editor_name'],$_GET['version'],$_GET['anno']);
    }
    else{
