...
namespace GravityKit\GravityExport\GrahamCampbell\GuzzleFactory;

use GravityKit\GravityExport\GuzzleHttp\BodySummarizer;
use GravityKit\GravityExport\GuzzleHttp\Client;
use GravityKit\GravityExport\GuzzleHttp\Exception\ConnectException;
use GravityKit\GravityExport\GuzzleHttp\Exception\TransferException;
use GravityKit\GravityExport\GuzzleHttp\HandlerStack;
use GravityKit\GravityExport\GuzzleHttp\Middleware;
...
final class GuzzleFactory
{
     ...
     *
     * @return \GravityKit\GravityExport\GuzzleHttp\Client
     */
     ...
     * @param int[]|null                    $codes
     * @param int|null                      $retries
     * @param \GravityKit\GravityExport\GuzzleHttp\HandlerStack|null $stack
     *
     * @return \GravityKit\GravityExport\GuzzleHttp\HandlerStack
     */
