...
use Exception;
use GravityKit\GravityExport\GrahamCampbell\GuzzleFactory\GuzzleFactory;
use GravityKit\GravityExport\GuzzleHttp\Client as GuzzleClient;
use GravityKit\GravityExport\GuzzleHttp\ClientInterface;
use GravityKit\GravityExport\GuzzleHttp\Exception\ClientException;
use GravityKit\GravityExport\GuzzleHttp\Exception\RequestException;
use GravityKit\GravityExport\GuzzleHttp\Psr7;
use GravityKit\GravityExport\GuzzleHttp\Psr7\PumpStream;
use GravityKit\GravityExport\GuzzleHttp\Psr7\StreamWrapper;
...
class Client
{
    ...
    /** @var \GravityKit\GravityExport\GuzzleHttp\Client */
    protected $client;
     ...
     * @param int $chunkSize
     * @param \GravityKit\GravityExport\Spatie\Dropbox\UploadSessionCursor|null $cursor
     * @return \GravityKit\GravityExport\Spatie\Dropbox\UploadSessionCursor
     * @throws Exception
     */
     ...
     *
     * @param string|StreamInterface $contents
     * @param \GravityKit\GravityExport\Spatie\Dropbox\UploadSessionCursor $cursor
     * @param string $path
     ...
     * @param $contents
     *
     * @return \GravityKit\GravityExport\GuzzleHttp\Psr7\PumpStream|\GravityKit\GravityExport\GuzzleHttp\Psr7\Stream|StreamInterface
     */
