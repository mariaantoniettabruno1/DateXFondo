...
namespace GravityKit\GravityExport\phpseclib\File;
...
use GravityKit\GravityExport\phpseclib\File\ASN1\Element;
use GravityKit\GravityExport\phpseclib\Math\BigInteger;
use DateTime;
use DateTimeZone;
...
class X509
{
    ...
    /**#@+
     * @access public
     * @see \GravityKit\GravityExport\phpseclib\File\X509::getDN()
    */
    /**
    ...
    /**#@+
     * @access public
     * @see \GravityKit\GravityExport\phpseclib\File\X509::saveX509()
     * @see \GravityKit\GravityExport\phpseclib\File\X509::saveCSR()
     * @see \GravityKit\GravityExport\phpseclib\File\X509::saveCRL()
    */
    /**
     * Save as PEM
     *
     ...
     * Default Constructor.
     *
     * @return \GravityKit\GravityExport\phpseclib\File\X509
     * @access public
     */
    ...
    function saveX509($cert, $format = self::FORMAT_PEM)
    {
        ...
        /* in the case of policyQualifiers/qualifier, the type has to be \phpseclib\File\ASN1::TYPE_IA5_STRING.
           \GravityKit\GravityExport\phpseclib\File\ASN1::TYPE_PRINTABLE_STRING will cause OpenSSL's X.509 parser to spit out random
           characters.
         */
     ...
     *
     * @param \GravityKit\GravityExport\phpseclib\File\X509 $issuer
     * @param \GravityKit\GravityExport\phpseclib\File\X509 $subject
    ...
    function sign($issuer, $subject, $signatureAlgorithm = 'sha1WithRSAEncryption')
    {
        ...
        if (isset($subject->domains) && count($subject->domains)) {
            $altName = array_map(array('\GravityKit\GravityExport\phpseclib\File\X509', '_dnsName'), $subject->domains);
        }
     ...
     *
     * @param \GravityKit\GravityExport\phpseclib\File\X509 $issuer
     * @param \GravityKit\GravityExport\phpseclib\File\X509 $crl
     * @param string $signatureAlgorithm optional
     * @access public
     * @return mixed
     */
     ...
     *
     * @param \GravityKit\GravityExport\phpseclib\File\X509 $key
     * @param string $signatureAlgorithm
     * @access public
     * @return mixed
     */
