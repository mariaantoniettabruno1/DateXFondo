 ...
 *
 *    $des = new \GravityKit\GravityExport\phpseclib\Crypt\DES();
 *
 *    $des->setKey('abcdefgh');
 *
 *    $size = 10 * 1024;
...
class DES extends Base
{
     ...
     * @see \GravityKit\GravityExport\phpseclib\Crypt\DES::_processBlock()
     */
    /**
     ...
     *
     * @see \GravityKit\GravityExport\phpseclib\Crypt\Base::block_size
     * @var int
     * @access private
     */
    var $block_size = 8;
     ...
     *
     * @see \GravityKit\GravityExport\phpseclib\Crypt\Base::openssl_mode_names
     * @var array
     * @access private
     */
     ...
     *
     * @see \GravityKit\GravityExport\phpseclib\Crypt\Base::isValidEngine()
     * @param int $engine
     * @access public
     * @return bool
     */
     ...
     * Encrypts a block
     *
     * @see \GravityKit\GravityExport\phpseclib\Crypt\Base::_encryptBlock()
     ...
     * Decrypts a block
     *
     * @see \GravityKit\GravityExport\phpseclib\Crypt\Base::_decryptBlock()
     ...
     *
     * @see \GravityKit\GravityExport\phpseclib\Crypt\Base::_setupInlineCrypt()
     * @access private
     */
