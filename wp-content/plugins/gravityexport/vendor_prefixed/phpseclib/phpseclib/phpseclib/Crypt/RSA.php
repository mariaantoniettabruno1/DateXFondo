 ...
 *
 *    $rsa = new \GravityKit\GravityExport\phpseclib\Crypt\RSA();
...
class RSA
{
    ...
    */
    ...
    /**#@+
     * @access private
     * @see \GravityKit\GravityExport\phpseclib\Crypt\RSA::createKey()
    */
    /**
     * ASN1 Integer
     */
    ...
    /**#@+
     * @access private
     * @see \GravityKit\GravityExport\phpseclib\Crypt\RSA::__construct()
    */
    /**
     ...
     * @access public
     * @see \GravityKit\GravityExport\phpseclib\Crypt\RSA::createKey()
     * @see \GravityKit\GravityExport\phpseclib\Crypt\RSA::setPrivateKeyFormat()
    */
    /**
     ...
     * @access public
     * @see \GravityKit\GravityExport\phpseclib\Crypt\RSA::createKey()
     * @see \GravityKit\GravityExport\phpseclib\Crypt\RSA::setPublicKeyFormat()
    */
    /**
     * Raw public key
     *
     ...
     * Precomputed Zero
     *
     * @var \GravityKit\GravityExport\phpseclib\Math\BigInteger
     * @access private
     */
    var $zero;
     ...
     * Hash function
     *
     * @var \GravityKit\GravityExport\phpseclib\Crypt\Hash
     * @access private
     */
    var $hash;
     ...
     *
     * @return \GravityKit\GravityExport\phpseclib\Crypt\RSA
     * @access public
     */
     ...
     * @access private
     * @param \GravityKit\GravityExport\phpseclib\Math\BigInteger $x
     * @param \GravityKit\GravityExport\phpseclib\Math\BigInteger $r
     * @param int $i
     * @return \GravityKit\GravityExport\phpseclib\Math\BigInteger
     */
     ...
     *
     * @access private
     * @param \GravityKit\GravityExport\phpseclib\Math\BigInteger $m
     * @return \GravityKit\GravityExport\phpseclib\Math\BigInteger
     */
    function _rsaep($m)
    {
     ...
     *
     * @access private
     * @param \GravityKit\GravityExport\phpseclib\Math\BigInteger $c
     * @return \GravityKit\GravityExport\phpseclib\Math\BigInteger
     */
    function _rsadp($c)
    {
     ...
     *
     * @access private
     * @param \GravityKit\GravityExport\phpseclib\Math\BigInteger $s
     * @return \GravityKit\GravityExport\phpseclib\Math\BigInteger
     */
    function _rsavp1($s)
    {
