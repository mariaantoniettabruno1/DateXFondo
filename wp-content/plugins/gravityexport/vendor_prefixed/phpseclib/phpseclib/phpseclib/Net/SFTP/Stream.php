...
namespace GravityKit\GravityExport\phpseclib\Net\SFTP;
...
class Stream
{
     ...
     * Flushes the output
     *
     * See <http://php.net/fflush>. Always returns true because \GravityKit\GravityExport\phpseclib\Net\SFTP doesn't cache stuff before writing
     *
     * @return bool
     * @access public
     */
