 ...
 *
 *    $ssh = new \GravityKit\GravityExport\phpseclib\Net\SSH1('www.domain.tld');
...
use GravityKit\GravityExport\phpseclib\Crypt\DES;
...
class SSH1
{
     ...
     * Encryption Methods
     *
     * @see \GravityKit\GravityExport\phpseclib\Net\SSH1::getSupportedCiphers()
     * @access public
     */
    /**
     * No encryption
     ...
     *
     * @see \GravityKit\GravityExport\phpseclib\Net\SSH1::getSupportedAuthentications()
     * @access public
    */
    /**
    ...
    */
     ...
     * The Response Type
     *
     * @see \GravityKit\GravityExport\phpseclib\Net\SSH1::_get_binary_packet()
     * @access private
     */
     ...
     *
     * @see \GravityKit\GravityExport\phpseclib\Net\SSH1::bitmap
     * @access private
    */
    ...
    /**#@+
     * @access public
     * @see \GravityKit\GravityExport\phpseclib\Net\SSH1::getLog()
    */
    /**
    ...
    /**#@+
     * @access public
     * @see \GravityKit\GravityExport\phpseclib\Net\SSH1::read()
    */
    /**
     ...
     * @param int $timeout
     * @param int $cipher
     * @return \GravityKit\GravityExport\phpseclib\Net\SSH1
     * @access public
     */
    ...
    function _connect()
    {
        ...
        switch ($cipher) {
            ...
            //    $this->crypto = new \GravityKit\GravityExport\phpseclib\Crypt\Null();
            //    break;
     ...
     *
     * To execute further commands, a new \GravityKit\GravityExport\phpseclib\Net\SSH1 object will need to be created.
     *
    ...
    function exec($cmd, $block = true)
    {
        ...
        // reset the execution bitmap - a new \GravityKit\GravityExport\phpseclib\Net\SSH1 object needs to be created.
        $this->bitmap = 0;
