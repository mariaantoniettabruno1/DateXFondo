 ...
 *
 *    $sftp = new \GravityKit\GravityExport\phpseclib\Net\SFTP('www.domain.tld');
...
class SFTP extends SSH2
{
    ...
    /**#@+
     * @access public
     * @see \GravityKit\GravityExport\phpseclib\Net\SFTP::put()
    */
    /**
     ...
     * @param int $port
     * @param int $timeout
     * @return \GravityKit\GravityExport\phpseclib\Net\SFTP
     * @access public
     */
     ...
     *
     * By default, \GravityKit\GravityExport\phpseclib\Net\SFTP::put() does not read from the local filesystem.  $data is dumped directly into $remote_file.
