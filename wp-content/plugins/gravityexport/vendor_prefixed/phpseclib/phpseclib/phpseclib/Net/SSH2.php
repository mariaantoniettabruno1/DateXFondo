 ...
 *
 *    $ssh = new \GravityKit\GravityExport\phpseclib\Net\SSH2('www.domain.tld');
 ...
 *    include 'vendor/autoload.php';
 *
 *    $key = new \GravityKit\GravityExport\phpseclib\Crypt\RSA();
...
namespace GravityKit\GravityExport\phpseclib\Net;

use GravityKit\GravityExport\phpseclib\Crypt\Base;
use GravityKit\GravityExport\phpseclib\Crypt\Blowfish;
use GravityKit\GravityExport\phpseclib\Crypt\Hash;
use GravityKit\GravityExport\phpseclib\Crypt\Random;
use GravityKit\GravityExport\phpseclib\Crypt\RC4;
use GravityKit\GravityExport\phpseclib\Crypt\Rijndael;
use GravityKit\GravityExport\phpseclib\Crypt\RSA;
use GravityKit\GravityExport\phpseclib\Crypt\TripleDES;
use GravityKit\GravityExport\phpseclib\Crypt\Twofish;
use GravityKit\GravityExport\phpseclib\Math\BigInteger; // Used to do Diffie-Hellman key exchange and DSA/RSA signature verification.
use GravityKit\GravityExport\phpseclib\System\SSH\Agent;
...
class SSH2
{
     ...
     *
     * @see \GravityKit\GravityExport\phpseclib\Net\SSH2::bitmap
     * @access private
     */
     ...
     *     the other side.
     *
     * @see \GravityKit\GravityExport\phpseclib\Net\SSH2::_send_channel_packet()
     * @see \GravityKit\GravityExport\phpseclib\Net\SSH2::_get_channel_packet()
     * @access private
    */
    ...
    /**#@+
     * @access public
     * @see \GravityKit\GravityExport\phpseclib\Net\SSH2::getLog()
    */
    /**
    ...
    /**#@+
     * @access public
     * @see \GravityKit\GravityExport\phpseclib\Net\SSH2::read()
    */
    /**
     ...
     * @param int $timeout
     * @see self::login()
     * @return \GravityKit\GravityExport\phpseclib\Net\SSH2
     * @access public
     */
     ...
     *
     * @param string $username
     * @param \GravityKit\GravityExport\phpseclib\System\SSH\Agent $agent
     * @return bool
     * @access private
     */
     ...
     *
     * @param string $username
     * @param \GravityKit\GravityExport\phpseclib\Crypt\RSA $privatekey
     * @return bool
     * @access private
     * @internal It might be worthwhile, at some point, to protect against {@link http://tools.ietf.org/html/rfc4251#section-9.3.9 traffic analysis}
     *           by sending dummy SSH_MSG_IGNORE messages.
