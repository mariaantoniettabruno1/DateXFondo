 ...
 *        exit('bad login');
 *    }
 *    $scp = new \GravityKit\GravityExport\phpseclib\Net\SCP($ssh);
 *
...
class SCP
{
    /**#@+
     * @access public
     * @see \GravityKit\GravityExport\phpseclib\Net\SCP::put()
     */
    /**
    ...
    /**#@+
     * @access private
     * @see \GravityKit\GravityExport\phpseclib\Net\SCP::_send()
     * @see \GravityKit\GravityExport\phpseclib\Net\SCP::_receive()
    */
    /**
     * SSH1 is being used.
     */
     ...
     *
     * @param \GravityKit\GravityExport\phpseclib\Net\SSH1|\GravityKit\GravityExport\phpseclib\Net\SSH2 $ssh
     * @return \GravityKit\GravityExport\phpseclib\Net\SCP
     * @access public
     */
     ...
     *
     * By default, \GravityKit\GravityExport\phpseclib\Net\SCP::put() does not read from the local filesystem.  $data is dumped directly into $remote_file.
