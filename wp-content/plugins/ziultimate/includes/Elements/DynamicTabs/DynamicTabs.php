...
class DynamicTabs extends UltimateElements {
	...
	public function render( $options ) {
		...
		if( ! self::isBuilderEditor() && !$hasTabs )
			return;
	?>
	<article class="zu-tabs zu-tabs-<?php echo $layout; ?> tpl-<?php echo $template; ?> zu-tabs-clearfix" data-acrd-toggle-speed="<?php echo $td_acrd; ?>">
		...
		<section class="zu-tabs-panels zu-tabs-clearfix">
			...
			?>
				<div class="zu-tabs-panel">
					<div class="zu-tabs-label zu-tabs-panel-label <?php echo $anim; ?><?php if ( 0 == $key ) { echo ' zu-tab-active';} ?>" data-index="<?php echo $key; ?>" tabindex="<?php echo $tabindex; ?>">
